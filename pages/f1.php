...
<div id="monCarousel" class="carousel slide section" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../image_static/f11.png" class="d-block w-100 monImg" alt="...">
        ...
        <?php 
           ...
           FROM items LEFT JOIN sports ON items.sport = sports.id WHERE sports.id=3 ORDER BY items.id DESC');
           $a = $statement->execute();
