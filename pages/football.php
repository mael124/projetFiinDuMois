...
<div id="monCarousel" class="carousel slide section" data-ride="carousel">
              
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../image_static/c12.png" class="d-block w-100 monImg" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h1>La League Des Champion Revient Bientot</h1>
                      <p>Quart de final</p>
                    </div>
                  </div>
                  </div>
        ...
        <?php 
           ...
           FROM items LEFT JOIN sports ON items.sport = sports.id WHERE sports.id=1 ORDER BY items.id DESC');
           $a = $statement->execute();
           ...
           while ($article = $statement->fetch()){
             ...
             echo ' <a href="view.php?id='.$article['id'].'">';
              echo '<img src="../images/'.$article["image"].'" class="" alt="..." heigth ="100px">';
