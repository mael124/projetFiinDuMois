...
<div id="monCarousel" class="carousel slide section" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../image_static/acc22.png" class="d-block w-100 monImg" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h1>Revivez Les Moment Chaud de La Soirée NBA</h1>
                    </div>
                  </div>
                  </div>
                </div>
        ...
        <?php 
           ...
           FROM items LEFT JOIN sports ON items.sport = sports.id WHERE sports.id=4 ORDER BY items.id DESC');
           $a = $statement->execute();
